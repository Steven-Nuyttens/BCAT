<?php
  ...
  while(have_posts()) {
    ...
    <div class="container container--narrow page-section">
        ...
        <p><a class="metabox__blog-home-link" href="<?php echo get_post_type_archive_link('coaches'); ?>"><i class="fa fa-user" aria-hidden="true"></i> Coaches</a> <span class="metabox__main"><?php the_title(); ?></span></p>
      </div>
